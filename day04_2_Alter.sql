...
-- SORU7: Maasi 3000'e esit ve kucuk olan degerler veri olarak girilmesin.
alter table isciler add constraint check (maas<=3000);
-- maasi 3000 ve ustunu kabul eder, etmeyecegi sayilar 2999'dan baslar.

alter table isciler drop column cinsiyet;
alter table isciler drop column yas;

INSERT INTO isciler VALUES(123456711, 'Ali Yilmaz', 'Istanbul', 3000, 'Honda');   -- kabul etti
INSERT INTO isciler VALUES(124656710, 'Ali Yilmaz', 'Istanbul', 2000, 'Honda');   -- kabul etti
INSERT INTO isciler VALUES(124656810, 'Ali Yilmaz', 'Istanbul', 7000, 'Honda');   -- kabul etmedi
INSERT INTO isciler VALUES(124656812, 'Ali Yilmaz', 'Istanbul', 3001, 'Honda');   -- kabul etti
