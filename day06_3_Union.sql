/*======================== SET OPERATORLERI: UNION, UNION ALL==========================
    ...
    UNION, UNION ALL, (oracleSql'deki karsiligi -> INTERSECT, ve MINUS) 
    gibi SET operatorleri yardimiyla coklu Sorgular birlestirilebilir.
    ...
    NOT:  Birlesik olan olansSorgu ifadesinin veri turu diger sorgulardaki 
...
select isim as isim_sehir, maas from personel where isim='Mehmet Ozturk' union
select sehir, maas from personel where sehir='Istanbul' order by maas desc;
...
------------------------------------------------------------------------------*/  
select isim, sirket from personel where sirket ='Honda' union
select isim, sirket from personel where sirket ='Ford' union
...
/* -----------------------------------------------------------------------------
  SORU4: 5000’den az maas alanlarin bilgileri ile, Honda calisani olmayanlarin bilgilerini
 alt alta listeleyen bir sorgu yaziniz. 
------------------------------------------------------------------------------*/ 
-- select * from personel where maas <5000;
-- select * from personel where sirket <> 'Honda';

select * from personel where maas <5000 union
select * from personel where sirket <> 'Honda';
